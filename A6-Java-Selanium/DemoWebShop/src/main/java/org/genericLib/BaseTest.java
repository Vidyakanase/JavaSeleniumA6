...
public class BaseTest implements FrameWorkConstants 
{
  public static WebDriver driver;
	...
	public void broweserSetUp() {
		String browserValue = Flib.getPropertyValue(PROPERTY_PATH_MAIN,"Chrome");
		String Url = Flib.getPropertyValue(PROPERTY_PATH_MAIN,"Url");
    ...
    @BeforeMethod
      public void login() {
	    String email = Flib.getPropertyValue(PROPERTY_PATH_MAIN,"email");
		String password = Flib.getPropertyValue(PROPERTY_PATH_MAIN,"password");
